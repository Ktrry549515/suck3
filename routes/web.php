...
Route::post('admin/store/catgory', 'Admin\Category\CategoryController@storecategory')->name('store.category');
...
//Add to Cart Route 添加到購物車
Route::get('add/to/cart/{id}', 'CartController@AddCart');
Route::get('check', 'CartController@check');

Route::get('product/cart', 'CartController@ShowCart')->name('show.cart');
Route::get('remove/cart/{rowId}', 'CartController@removeCart');
Route::post('update/cart/item/', 'CartController@UpdateCart')->name('update.cartiem');
...
Route::get('language/taiwan', 'BlogController@Taiwan')->name('language.taiwan');
...
//Order Report Routes
Route::get('admin/today/update', 'Admin\ReportController@TodayOrder')->name('today.order');
Route::get('admin/today/delivary', 'Admin\ReportController@TodayDelivary')->name('today.delivary');
Route::get('admin/today/month', 'Admin\ReportController@ThisMonth')->name('today.this.month');
Route::get('admin/search/report', 'Admin\ReportController@Search')->name('search.report');

Route::post('admin/search/year', 'Admin\ReportController@SearchByYear')->name('search.by.year');
Route::post('admin/search/month', 'Admin\ReportController@SearchByMonth')->name('search.by.month');
Route::post('admin/search/date', 'Admin\ReportController@SearchByDate')->name('search.by.date');
...
Route::post('admin/update/admin', 'Admin\UserRoleController@Updatedate')->name('update.admin');
...
Route::get('admin/return/request/', 'Admin\ReturnController@ReturnRequest')->name('admin.returnn.request');

Route::get('admin/approve/return/{id}', 'Admin\ReturnController@ApproveReturn');
Route::get('admin/return/return/', 'Admin\ReturnController@AllReturn')->name('admin.all.return');

//Order Stock Route 庫存
