...
<body>
                        ...
                        <div class="col d-flex flex-row">
                            <div class="top_bar_contact_item">
                                ...
                                <div class="top_bar_icon">
                                    <a href="{{  route('admin.login')  }}">Admin area</a>
                                </div>
                                <div class="top_bar_icon">
                            ...
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon">
                                    <img src="{{  asset('public/frontend/images/mail.png')  }}" alt="">
                                </div>
                            ...
                            <div class="top_bar_content ml-auto">
                                ...
                                <div class="top_bar_menu">
                                    <ul class="standard_dropdown top_bar_dropdown">
                                        ...
                                        <li>
                                            <a href="" data-toggle="modal" data-target="#exampleModal">我的訂單追蹤</a>
                                        </li>
                                    </ul>
                                </div>
                                @endguest
                                ...
                                <div class="top_bar_menu">
                                    <ul class="standard_dropdown top_bar_dropdown">
                                        ...
                                        <li>
                                            ...
                                            @else
                                            <a href="{{ route('language.taiwan') }}">Taiwan<i
                                                    class="fas fa-chevron-down"></i></a>
                                            @endif
                                        </li>
                                    </ul>
                                ...
                                <div class="top_bar_user">
                                    ...
                                    <ul class="standard_dropdown top_bar_dropdown">
                                        <li>
                                            ...
                                            <ul>
                                                <li><a href="{{ route('user.wishlist') }}">追蹤清單</a></li>
                                                <li><a href="{{ route('user.checkout') }}">確認訂單</a></li>
                                                <li><a href="#">其他</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                            ...
                            <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                                <div class="wishlist d-flex flex-row align-items-center justify-content-end">
                                    ...
                                    <div class="wishlist_content">
                                        <div class="wishlist_text"><a href="#">追蹤清單</a></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 footer_col">
                            <div class="footer_column footer_contact">
                                <div class="logo_container">
                                    <div class="logo"><a href="#"><b>{{ $setting->company_name }}</b></a></div>
                                </div>
    ...
    <!--Order Tranking Modal -->
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">您的狀態碼</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('order.tracking') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name="code" required="" class="form-control" placeholder="您的狀態碼">
                        </div>
                        <button class="btn btn-danger" type="submit">立即追蹤</button>
