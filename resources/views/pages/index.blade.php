            ...
            <div class="container">
                                        ...
                                        <div class="bestsellers_slider slider">
                                            ...
                                            <div class="bestsellers_item discount">
                                                <div
                                                    ...
                                                    <div class="bestsellers_image"><img
                                                            src="{{  asset('public/frontend/images/best_1.png')  }}"
                                                            alt="">
                                                    </div>
                                            ...
                                            <div class="bestsellers_item discount">
                                                <div
                                                    class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                    <div class="bestsellers_image"><img
                                                            src="{{  asset('public/frontend/images/best_2.png')  }}"
                                                            alt="">
                                                    </div>
                                                    <div class="bestsellers_content">
                                                        <div class="bestsellers_category"><a href="#">Headphones</a>
                                            ...
                                            <div class="bestsellers_item">
                                                <div
                                                    class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                    <div class="bestsellers_image"><img
                                                            src="{{  asset('public/frontend/images/best_3.png')  }}"
                                                            alt="">
                                                    </div>
                                                    <div class="bestsellers_content">
                                                        <div class="bestsellers_category"><a href="#">Headphones</a>
                                            ...
                                            <div class="bestsellers_item">
                                                <div
                                                    class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                    <div class="bestsellers_image"><img
                                                            src="{{  asset('public/frontend/images/best_4.png')  }}"
                                                            alt="">
                                                    </div>
                                                    <div class="bestsellers_content">
                                                        <div class="bestsellers_category"><a href="#">Headphones</a>
                                            ...
                                            <div class="bestsellers_item discount">
                                                <div
                                                    class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                    <div class="bestsellers_image"><img
                                                            src="{{  asset('public/frontend/images/best_5.png')  }}"
                                                            alt="">
                                                    </div>
                                                    <div class="bestsellers_content">
                                                        <div class="bestsellers_category"><a href="#">Headphones</a>
                                            ...
                                            <div class="bestsellers_item">
                                                <div
                                                    class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                                    <div class="bestsellers_image"><img
                                                            src="{{  asset('public/frontend/images/best_6.png')  }}"
                                                            alt="">
                                                    </div>
                                                    <div class="bestsellers_content">
                                                        <div class="bestsellers_category"><a href="#">Headphones</a>
                        ...
                        <div class="row">
                                ...
                                <div class="advert d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="ml-auto">
                                        <div class="advert_image"><img
                                                src="{{  asset('public/forntend/images/adv_1.png') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 advert_col">
                                ...
                                <div class="advert d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="ml-auto">
                                        <div class="advert_image"><img
                                                src="{{  asset('public/forntend/images/adv_2.png')  }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 advert_col">
                                ...
                                <div class="advert d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="ml-auto">
                                        <div class="advert_image"><img
                                                src="{{  asset('public/forntend/images/adv_3.png')  }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="trends">
                    <div class="trends_background"
                        style="background-image:url(public/frontend/images/trends_background.jpg)">
                    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="reviews_title_container">
                                    <h3 class="reviews_title">最新評論</h3>
                                    <div class="reviews_all ml-auto"><a href="{{ route('blog.post') }}">查看所有 <span>評論</span></a></div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="newsletter_title_container">
                                        <div class="newsletter_icon"><img
                                                src="{{  asset('public/frontend/images/send.png')  }}" alt="">
                                        </div>
                                        <div class="newsletter_title">訂閱電子報</div>
                                    ...
                                    <div class="newsletter_content clearfix">
                                        <form action="{{ route('store.newslater') }}" method="post"
                                            ...
                                            <input type="email" class="newsletter_input" required="required"
                                                placeholder="輸入您的電子郵件地址" name="email">
                                            <button class="newsletter_button" type="submit">訂閱</button>
                                        </form>
                                       <br><br><br> <div class="newsletter_unsubscribe_link"><a href="#"><h4><b>取消訂閱</b></h4></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card">
                                            <img src="" class="text-center" id="pimage"
