        ...
        <div class="row">
            <div class="col-lg-7" style="border: 2px solid gray;padding:20px;border-radius:25px;">
                <div class="contact_form_container">
                    <div class="contact_form_title text-center"></div>
                            ...
                            <li class="cart_item clearfix">
                                ...
                                <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                    ...
                                    <div class="cart_item_name cart_info_col">
                                        <div class="cart_item_title"><b>產品圖片</b></div>
            ...
            <div class="col-lg-5" style="border: 2px solid gray;padding:20px;border-radius:25px;">
                <div class="contact_form_container">
                    <div class="contact_form_title text-center">信用卡</div>
                    ...
                    <form action="{{ route('stripe.charge') }}" method="post" id="payment-form">
                        ...
                        <button class="btn btn-info">付款去</button>
                    </form>
...
<script>
    ...
    var stripe = Stripe(
        'pk_test_51HCziiDZExRfqXZ0OCTqX6k2IrM2T089mODNSPsGTO3wtf9wKSXp5exbgaZHdO1Sjw6aJ1x05iKQu9PUXIHqlbQd00TQLprIUk'
    );
