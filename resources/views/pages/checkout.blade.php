...
<link rel="stylesheet" type="text/css" href="{{  asset('public/frontend/cart_responsive.css')  }}">
...
<div class="cart_section">
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="cart_container">
                        ...
                        <ul class="cart_list">
                            ...
                            <li class="cart_item clearfix">
                                <div class="cart_item_image text-center"><br><img
                                        src="{{ asset($row->options->image) }}" style="width:70px; width:70px;" alt="">
                                </div>
                                <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                    <div class="cart_item_name cart_info_col">
                                        <div class="cart_item_title">產品名稱</div>
                                    ...
                                    <div class="cart_item_quantity cart_info_col">
                                        ...
                                        <form action="{{ route('update.cartiem') }}" method="post">
                                            @csrf

                                            <input type="hidden" name="productid" value="{{ $row->rowId }}">
                                            <input type="number" name="qty" value="{{ $row->qty }}"
                                                style="width: 60px;">
                                            <button type="sibmit" class="btn btn-success btn-sm">
                                                <i class="fas fa-check-square"></i></button>
                                        </form>

                                    </div>
                                    <div class="cart_item_price cart_info_col">
                                        <div class="cart_item_title">價錢</div>
                                    ...
                                    <div class="cart_item_total cart_info_col">
                                        <div class="cart_item_title">功能</div><br>
                    ...
                    <div class="order_total_content" style="padding:15px;">
                        ...
                        <h5 style="margin-left: 20px;">使用優惠券</h5>
        ...
        <div class="cart_buttons">
            ...
            <a href="{{ route('payment.step') }}" class="button cart_button_checkout">最後確認</a>
        </div>
    </div>
</div>
</div>
