...
<head>
    ...
    <title>Ecommerce Site Admin Panl</title>
        ...
        <div class="sl-sideleft-menu">
            <a href="{{  url('admin/home') }}" class="sl-menu-link active">
                <div class="sl-menu-item">
                    ...
                    <span class="menu-item-label">主頁面</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{  route('categories')  }}" class="nav-link">類別</a></li>
                <li class="nav-item"><a href="{{  route('sub.categories')  }}" class="nav-link">子類別</a></li>
                <li class="nav-item"><a href="{{ route('brands') }}" class="nav-link">品牌</a></li>
            </ul>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    ...
                    <span class="menu-item-label">優惠券</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.coupon') }}" class="nav-link">優惠券</a></li>
            </ul>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    ...
                    <span class="menu-item-label">產品展示</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('add.product') }}" class="nav-link">添加產品</a></li>
                <li class="nav-item"><a href="{{ route('all.product') }}" class="nav-link">全部商品</a></li>
            </ul>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-20"></i>
                    <span class="menu-item-label">訂購</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.cancel.order') }}" class="nav-link">取消訂單</a></li>
                <li class="nav-item"><a href="{{ route('admin.process.payment') }}" class="nav-link">出貨</a></li>
                <li class="nav-item"><a href="{{ route('admin.success.payment') }}" class="nav-link">交易成功</a></li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('add.blog.categorylist') }}" class="nav-link">部落格類別</a>
                </li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.seo') }}" class="nav-link">SEO 設置</a></li>
            </ul>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">出貨明細</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('today.order') }}" class="nav-link">今日訂單</a></li>
                <li class="nav-item"><a href="{{ route('today.delivary') }}" class="nav-link">今天發貨</a></li>
                <li class="nav-item"><a href="{{ route('today.this.month') }}" class="nav-link">本月明細</a></li>
                <li class="nav-item"><a href="{{ route('search.report') }}" class="nav-link">搜尋</a></li>
            </ul>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">用戶角色</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">退貨訂單</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.returnn.request') }}" class="nav-link">退貨請求</a></li>
                <li class="nav-item"><a href="{{ route('admin.all.return') }}" class="nav-link">所有請求</a></li>
            </ul>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">內容訊息</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('all.message') }}" class="nav-link">所有訊息</a></li>
            </ul>
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">產品評論留言</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
            ...
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">網站設定</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.site.setting') }}" class="nav-link">網站設定</a></li>
            </ul>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            <li><a href=""><i class="icon ion-ios-person-outline"></i>編輯個人資料</a></li>
                            <li><a href="{{  route('admin.password.change')  }}">
                                    <i class="icon ion-ios-gear-outline"></i>設定</a></li>
                            <li><a href="{{  route('admin.logout')  }}"><i class="icon ion-power"></i>登出</a></li>
                        </ul>
                    </div><!-- dropdown-menu -->
                </div><!-- dropdown -->
            </nav>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="notifications" role="tabpanel">
                <div class="media-list">
                    ...
                    <a href="" class="media-list-link read">
                        <div class="media pd-x-20 pd-y-15">
                            <img src="{{  asset('public/backend/img/img10.jpg'  )}}" class="wd-40 rounded-circle"
                                alt="">
                            <div class="media-body">
